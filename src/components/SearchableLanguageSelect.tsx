  ...
  return (
    <div className="flex flex-col gap-1.5 relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="w-full bg-slate-950 text-slate-100 border border-slate-800 hover:border-slate-700 rounded-xl px-3.5 py-2.5 text-xs flex items-center justify-between transition-colors focus:ring-2 focus:ring-indigo-500 focus:outline-none"
      >
      ...
      {/* Popover Dropdown */}
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-1 z-30 bg-slate-900 border border-slate-800 rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-72 animate-slide-up">
          ...
          <div className="p-2 border-b border-slate-800 bg-slate-950/80 sticky top-0">
            <div className="relative">
              ...
              <input
                ...
                autoFocus
                className="w-full bg-slate-900 border border-slate-800 text-slate-200 rounded-lg pr-9 pl-3 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-indigo-500 placeholder:text-slate-500"
              />
            </div>
          </div>
