        ...
        <div
          ...
          className={`relative border-2 border-dashed rounded-xl p-8 lg:p-10 text-center cursor-pointer transition-all duration-300 flex flex-col items-center justify-center gap-3 ${
            isDragging
              ...
              : 'border-slate-300 dark:border-slate-700 hover:border-indigo-500/60 bg-slate-50/60 dark:bg-slate-950/40 hover:bg-slate-100/60 dark:hover:bg-slate-800/40'
          }`}
        >
          <input
            type="file"
          ...
          <div className="w-14 h-14 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 dark:text-indigo-400 flex items-center justify-center group-hover:scale-110 transition-transform shadow-inner">
          ...
          <div className="flex flex-wrap items-center justify-center gap-1.5 mt-2">
            {['.SRT', '.VTT', '.ASS', '.SSA', '.SUB'].map((fmt) => (
              <span key={fmt} className="text-[10px] font-mono font-bold px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 text-indigo-700 dark:text-indigo-300 border border-slate-200 dark:border-slate-700">
                {fmt}
              </span>
            ))}
          </div>
          ...
          {/* Quick Test Button */}
          <div className="mt-3 pt-3 border-t border-slate-200 dark:border-slate-800/80 w-full flex items-center justify-center">
            <button
              type="button"
          ...
          <div className="flex items-center gap-3.5 w-full md:w-auto">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="uppercase text-[10px] font-mono font-extrabold px-2 py-0.5 rounded bg-indigo-500/10 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 border border-indigo-500/30">
                  {currentFormat}
                </span>
              </div>
